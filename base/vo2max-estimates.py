...
# приблизительный расчет ћѕ  из: 
# данных о весе, возрасте и пульсе поко€ (vo2maxWAHR)
# данных о поле, обхвате талии, возрасте, пульсе поко€, уровне активности, интенсивности тренировок и их частоты
#
